...
- 多人模式保留意愿调查会发送用户选择或填写的答案、调查标识、调查专用匿名标识、完成状态、事件时间、事件名和公开项目令牌。布局调查会发送问卷回答、调查标识、调查专用匿名标识、应用版本、当前布局、调查结构版本、事件时间、事件名和公开项目令牌，并沿用既有的单人 / 多人模式匿名身份规则。两者都不发送原始安装身份、账号、Cookie、作品或本地路径。
