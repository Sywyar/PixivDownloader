...
val ideCoreApiClasses = layout.projectDirectory.dir("../pixivdownload-core-api/target/classes")
val sdkClasspath = if (mavenClasspathReady) mavenClasspath else files(idePluginApiClasses, ideCoreApiClasses)
