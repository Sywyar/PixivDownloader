...
| `{root}/{artworkId}/{artworkId}.meta.json` | Structural Pixiv metadata generated by web, userscript, and scheduled downloads from data already fetched, without an extra Pixiv request; moved/deleted with the work and excluded from quota packages and novel exports (novels use `novel-{novelId}/{novelId}.meta.json`) |
