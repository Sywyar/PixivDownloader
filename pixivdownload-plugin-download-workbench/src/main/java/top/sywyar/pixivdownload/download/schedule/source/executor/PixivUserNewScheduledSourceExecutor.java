...
/** Pixiv 画师新作来源执行适配器。 */
@PluginManagedBean
public final class PixivUserNewScheduledSourceExecutor implements ScheduledSourceExecutor {

    private final PixivScheduledSourceSupport support;

    public PixivUserNewScheduledSourceExecutor(PixivScheduledSourceSupport support) {
