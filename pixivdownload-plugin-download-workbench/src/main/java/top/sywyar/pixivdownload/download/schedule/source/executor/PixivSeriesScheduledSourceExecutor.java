...
/** Pixiv 系列来源执行适配器。 */
@PluginManagedBean
public final class PixivSeriesScheduledSourceExecutor implements ScheduledSourceExecutor {

    private final PixivScheduledSourceSupport support;

    public PixivSeriesScheduledSourceExecutor(PixivScheduledSourceSupport support) {
