...
### [浅色模式使用截图](./light-screenshot.md)
### [暗色模式使用截图](./dark-screenshot.md)
...
| `PixivDownload-*-win-x64-online-portable.zip` | Windows 在线便携版，体积最小；无内嵌 Fmmpeg                      |
| `PixivDownload-*-win-x64-portable.zip`        | Windows 离线便携版，已内嵌 FFmpeg，适合未安装 FFmpeg 或离线环境        |
...
| `Pixiv URL 批量导入单作品下载器.user.js`           | 批量导入单作品下载，兼容 One-Tab、N-Tab 等标签页管理插件导出格式 | `pixiv-batch.html` / GitHub 代码区           |
