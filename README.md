...
- 通过油猴脚本在Pixiv网页上抓取漫画 (截至v1.8.0版本 暂时只能支持漫画相关作品)
- 强大的作品查看页面(此文档简称画廊，实际支持小说)
...
- 一站式下载网页
- 页面批量下载脚本 — 抓取搜索页、关注动态、排行榜等Pixiv全站抓取页面中的所有作品
- 体验增强工具箱脚本
...
| `Pixiv 页面批量下载器(Page Scrape).user.js`      | 页面 DOM 抓取，支持 Pixiv 全站抓取                                          | `pixiv-batch.html` / GitHub 代码区           |
| `Pixiv 体验增强工具箱(Toolbox).user.js`          | 模块化体验增强工具箱（可逐项开关）；首个功能：已下载作品缩略图加边框，需本机 localhost + solo 模式 + 已登录 | `pixiv-batch.html` / GitHub 代码区           |
