...
public final class DouyinSourceTypes {

    public static final String SINGLE = "douyin.single";
    public static final String USER = "douyin.user";
    public static final String SEARCH = "douyin.search";
    public static final String COLLECTION = "douyin.collection";
    public static final String MUSIC = "douyin.music";
