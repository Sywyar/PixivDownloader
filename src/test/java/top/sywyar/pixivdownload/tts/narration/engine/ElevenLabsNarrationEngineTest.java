...
class ElevenLabsNarrationEngineTest {
    ...
    void usesProxy() {
        NarrationTtsConfig cfg = config("https://api.elevenlabs.io", "k", "v");
    ...
    private ElevenLabsNarrationEngine engine(NarrationTtsConfig cfg) {
    ...
    private static NarrationTtsConfig config(String baseUrl, String apiKey, String voiceId) {
        ...
        NarrationTtsConfig.Elevenlabs el = new NarrationTtsConfig.Elevenlabs();
