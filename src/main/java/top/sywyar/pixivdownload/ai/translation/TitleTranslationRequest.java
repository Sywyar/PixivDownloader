...
public record TitleTranslationRequest(String targetLanguage, String sourceTitle,
    ...
    public TitleTranslationRequest(String targetLanguage, String sourceTitle) {
        this(targetLanguage, sourceTitle, List.of(), List.of());
    }
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            1. First decide whether the requested target language is a real, existing human (natural) language.
               If it is NOT a real language, respond with status "invalid_language" and an empty "title".
            ...
            4. Output ONE LINE only — no markdown, no code fences, no leading or trailing whitespace, no line breaks.
            5. A glossary of preferred term translations may be provided in the user message as a JSON array
               ...
               that "source" term exactly as its "target" anywhere it appears in the title. Ignore items whose
               "lang" differs from the target language.
            ...
            7. Output STRICT JSON ONLY (no markdown, no code fences, no extra text) with EXACTLY these fields:
