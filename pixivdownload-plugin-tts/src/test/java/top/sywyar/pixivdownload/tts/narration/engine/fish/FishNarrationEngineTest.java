package top.sywyar.pixivdownload.tts.narration.engine.fish;
...
import top.sywyar.pixivdownload.tts.narration.engine.TestMessageResolver;
...
class FishNarrationEngineTest {
    ...
    void usesProxy() {
        TtsPluginConfig cfg = config("https://api.fish.audio", "k");
    ...
    private FishNarrationEngine engine(TtsPluginConfig cfg) {
    ...
    private static TtsPluginConfig config(String baseUrl, String apiKey) {
        ...
        TtsPluginConfig.Fish fish = new TtsPluginConfig.Fish();
