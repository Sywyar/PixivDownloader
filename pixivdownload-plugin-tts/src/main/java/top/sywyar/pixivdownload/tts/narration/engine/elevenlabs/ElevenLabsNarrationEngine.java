package top.sywyar.pixivdownload.tts.narration.engine.elevenlabs;
...
import top.sywyar.pixivdownload.tts.narration.engine.http.AbstractHttpNarrationEngine;
...
public class ElevenLabsNarrationEngine extends AbstractHttpNarrationEngine implements NarrationVoiceEngine {
    ...
    public ElevenLabsNarrationEngine(TtsPluginConfig config,
    ...
    @Override
    public String id() {
        return TtsPluginConfig.ENGINE_ELEVENLABS;
    }
    ...
    public boolean isAvailable() {
        ...
        TtsPluginConfig.Elevenlabs el = config.getElevenlabs();
        return el != null
