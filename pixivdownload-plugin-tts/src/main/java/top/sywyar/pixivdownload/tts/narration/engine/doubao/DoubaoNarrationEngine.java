package top.sywyar.pixivdownload.tts.narration.engine.doubao;
...
public class DoubaoNarrationEngine extends AbstractHttpNarrationEngine implements NarrationVoiceEngine {
    ...
    public DoubaoNarrationEngine(TtsPluginConfig config,
    ...
    @Override
    public String id() {
        return TtsPluginConfig.ENGINE_DOUBAO;
    }
    ...
    public boolean isAvailable() {
        ...
        TtsPluginConfig.Doubao doubao = config.getDoubao();
        return doubao != null
