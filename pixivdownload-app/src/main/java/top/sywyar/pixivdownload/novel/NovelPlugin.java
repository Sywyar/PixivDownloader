...
/**
 * 小说核心插件：小说下载、Pixiv 小说代理、下载工作台小说队列类型与计划任务小说执行器。
 * 小说画廊 / 详情展示页面与 {@code /api/gallery/novel(s)} 展示 API 由外置 novel-gallery 插件声明。
 */
public class NovelPlugin implements PixivFeaturePlugin {
    ...
    public List<I18nContribution> i18n() {
        ...
        // novel-gallery 页面文案由外置插件的 novel-gallery namespace 贡献。
        return List.of(
