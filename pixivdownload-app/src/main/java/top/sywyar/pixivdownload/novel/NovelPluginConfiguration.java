...
/**
 * novel 插件的 Bean 装配收敛点：下载端点、Pixiv 小说代理、下载队列适配器与计划任务小说执行器
 * 经这里显式提供。小说画廊展示层由外置 novel-gallery 插件装配；novel-core 其余部分
 * （下载 / 正文 / 翻译 / TTS / AI 听书）仍走根包扫描，核心数据写入不受展示插件启停影响。
 * <p>
 ...
 * 装配 / 缺席——禁用本插件时小说下载 controller 与小说执行器都不在场，新旧小说下载 URL 因「未声明即 404」
