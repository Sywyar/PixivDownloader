...
public enum PluginCatalogErrorCode {
    ...
    REPOSITORY_DESCRIPTOR_URL_INVALID(HttpStatus.UNPROCESSABLE_ENTITY,
            "plugin.catalog.error.repository-descriptor-url-invalid"),
    REPOSITORY_DESCRIPTOR_FETCH_REJECTED(HttpStatus.BAD_GATEWAY,
            "plugin.catalog.error.repository-descriptor-fetch-rejected"),
    REPOSITORY_DESCRIPTOR_TOO_LARGE(HttpStatus.PAYLOAD_TOO_LARGE,
            "plugin.catalog.error.repository-descriptor-too-large"),
    REPOSITORY_DESCRIPTOR_INVALID(HttpStatus.UNPROCESSABLE_ENTITY,
            "plugin.catalog.error.repository-descriptor-invalid"),
    REPOSITORY_DESCRIPTOR_CHANGED(HttpStatus.CONFLICT,
            "plugin.catalog.error.repository-descriptor-changed"),
    REPOSITORY_ID_CONFLICT(HttpStatus.CONFLICT, "plugin.catalog.error.repository-id-conflict"),
    REPOSITORY_PROTOCOL_UNSUPPORTED(HttpStatus.UNPROCESSABLE_ENTITY,
            "plugin.catalog.error.repository-protocol-unsupported"),
    REPOSITORY_NETWORK_PROFILE_UNSUPPORTED(HttpStatus.UNPROCESSABLE_ENTITY,
            "plugin.catalog.error.repository-network-profile-unsupported"),
    REPOSITORY_KEY_INVALID(HttpStatus.UNPROCESSABLE_ENTITY,
            "plugin.catalog.error.repository-key-invalid"),
    REPOSITORY_TRUST_CONFIRMATION_REQUIRED(HttpStatus.UNPROCESSABLE_ENTITY,
            "plugin.catalog.error.repository-trust-confirmation-required"),
    REPOSITORY_DIRECTORY_ATTESTATION_INVALID(HttpStatus.UNPROCESSABLE_ENTITY,
            "plugin.catalog.error.repository-directory-attestation-invalid"),
    REPOSITORY_CONFIG_WRITE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR,
            "plugin.catalog.error.repository-config-write-failed"),
    REPOSITORY_UPDATE_PROOF_INVALID(HttpStatus.UNPROCESSABLE_ENTITY,
            "plugin.catalog.error.repository-update-proof-invalid"),
    REPOSITORY_UPDATE_ROLLBACK(HttpStatus.CONFLICT,
