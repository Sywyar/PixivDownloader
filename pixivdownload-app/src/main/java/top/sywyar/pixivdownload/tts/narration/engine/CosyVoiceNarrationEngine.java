...
public class CosyVoiceNarrationEngine extends AbstractHttpNarrationEngine implements NarrationVoiceEngine {
    ...
    public CosyVoiceNarrationEngine(NarrationTtsConfig config,
    ...
    @Override
    public String id() {
        return NarrationTtsConfig.ENGINE_COSYVOICE;
    }
    ...
    public boolean isAvailable() {
        NarrationTtsConfig.Cosyvoice cosy = config.getCosyvoice();
