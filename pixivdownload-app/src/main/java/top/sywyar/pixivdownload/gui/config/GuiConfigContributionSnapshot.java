...
/**
 * Plugin-contributed GUI configuration groups, fields and diagnostics after host aggregation.
 */
public record GuiConfigContributionSnapshot(
    ...
    public static GuiConfigContributionSnapshot empty() {
        return new GuiConfigContributionSnapshot(List.of(), List.of(), List.of());
    }
}
