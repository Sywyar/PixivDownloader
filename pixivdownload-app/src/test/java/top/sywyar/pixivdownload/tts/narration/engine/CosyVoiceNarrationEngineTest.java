...
class CosyVoiceNarrationEngineTest {
    ...
    private CosyVoiceNarrationEngine engine(NarrationTtsConfig cfg) {
        return new CosyVoiceNarrationEngine(cfg, direct, proxy, MESSAGES);
    }

    private static NarrationTtsConfig config(String baseUrl) {
        return config(baseUrl, "");
    }

    private static NarrationTtsConfig config(String baseUrl, String apiKey) {
        NarrationTtsConfig cfg = new NarrationTtsConfig();
        NarrationTtsConfig.Cosyvoice cosy = new NarrationTtsConfig.Cosyvoice();
