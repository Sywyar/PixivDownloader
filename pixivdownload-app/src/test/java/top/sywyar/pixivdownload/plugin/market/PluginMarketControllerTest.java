...
class PluginMarketControllerTest {
    ...
    void installSuccess() throws Exception {
        ...
        when(marketService.install("official", "demo", "1.0.0", (String) null, false)).thenReturn(report);
    ...
    void installRecoveryBlockedReturns503() throws Exception {
        when(marketService.install("official", "demo", "1.0.0", (String) null, false)).thenReturn(new PluginInstallReport(
    ...
    void installUnknownRepository() throws Exception {
        when(marketService.install("ghost", "demo", "1.0.0", (String) null, false)).thenThrow(new PluginCatalogException(
    ...
    void installDowngradeRejected() throws Exception {
        when(marketService.install("official", "demo", "0.9.0", (String) null, false)).thenReturn(new PluginInstallReport(
    ...
    void installUnknownVersion() throws Exception {
        when(marketService.install("official", "demo", "9.9.9", (String) null, false)).thenThrow(new PluginCatalogException(
    ...
    void installTooLarge() throws Exception {
        when(marketService.install("official", "demo", "1.0.0", (String) null, false)).thenThrow(new PluginCatalogException(
    ...
    void installDownloadFailed() throws Exception {
        ...
        when(marketService.install("official", "demo", "1.0.0", (String) null, false)).thenThrow(exception);
    ...
    void ignoresArbitraryUrlInBody() throws Exception {
        ...
        verify(marketService).install("official", "demo", "1.0.0", (String) null, false);
    }
    ...
    void installPassesExplicitIdentityMigrationConfirmation() throws Exception {
        when(marketService.install("official", "demo", "1.0.0", (String) null, true)).thenReturn(new PluginInstallReport(
                PluginInstallOutcome.INSTALLED, true, true, "demo", "1.0.0", null,
                List.of(), List.of(), List.of()));
        ...
        verify(marketService).install("official", "demo", "1.0.0", (String) null, true);
    }
    ...
    void installPassesExactArtifactTrustConfirmation() throws Exception {
        ...
        when(marketService.install("custom", "demo", "1.0.0", confirmedSha256, false)).thenReturn(new PluginInstallReport(
                PluginInstallOutcome.INSTALLED, true, true, "demo", "1.0.0", null,
                List.of(), List.of(), List.of()));
        ...
        verify(marketService).install("custom", "demo", "1.0.0", confirmedSha256, false);
    }
