...
Run this checklist before a desktop renderer migration release. Record the Windows version, JDK,
...
Automated structure and interaction coverage lives in `AppDesktopUiHostDocumentTest`,
`SwingDesktopUiNodeRendererTest` and `MainFrameRegressionTest`. Pixel screenshots are intentionally not a
