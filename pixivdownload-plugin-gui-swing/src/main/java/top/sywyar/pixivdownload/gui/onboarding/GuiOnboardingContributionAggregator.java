...
public final class GuiOnboardingContributionAggregator {
    ...
    public static GuiOnboardingSnapshot fromRegisteredPlugins(List<DesktopUiContext.PluginSource> registeredPlugins) {
    ...
    private static GuiOnboardingStepSpec toSpec(DesktopUiContext.PluginSource registered,
        ...
        List<I18nContribution> refreshableI18n = registered.builtIn() ? i18n : List.of();
        ClassLoader refreshableClassLoader = registered.builtIn()
    ...
    private static List<I18nContribution> pluginI18n(DesktopUiContext.PluginSource registered,
                                                     List<GuiOnboardingContributionDiagnostic> diagnostics) {
        try {
