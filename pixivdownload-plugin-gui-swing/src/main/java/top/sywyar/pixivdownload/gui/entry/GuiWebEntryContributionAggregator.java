...
public final class GuiWebEntryContributionAggregator {
    ...
    public static GuiWebEntrySnapshot fromRegisteredPlugins(List<DesktopUiContext.PluginSource> registeredPlugins) {
    ...
    private static GuiWebEntrySpec toSpec(DesktopUiContext.PluginSource registered,
