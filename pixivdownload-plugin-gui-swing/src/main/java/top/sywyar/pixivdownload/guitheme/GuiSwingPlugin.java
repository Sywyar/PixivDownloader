...
public class GuiSwingPlugin implements PixivFeaturePlugin, DesktopUiProvider {
    ...
    public static final String ID = "gui-swing";
    private static final String I18N_BUNDLE = "i18n.web.gui-swing";
    ...
    @Override
    public DesktopUiSession launch(DesktopUiContext context) throws Exception {
        return SwingDesktopUi.launch(context);
    }

    @Override
    public List<I18nContribution> i18n() {
        return List.of(new I18nContribution(ID, "i18n.web.gui-swing", 8));
    }
    ...
    private static String displayName(ThemePreference preference, Locale locale) {
        ...
        try {
            String name = ResourceBundle.getBundle(I18N_BUNDLE, effective, GuiSwingPlugin.class.getClassLoader())
                    .getString(key);
